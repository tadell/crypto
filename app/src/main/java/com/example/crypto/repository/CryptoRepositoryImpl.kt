...
class CryptoRepositoryImpl() : CryptoListRepository {
    ...
    override suspend fun getCryptoList(sortText: String,sortDesc: String,cryptoText: String,tagText: String): LiveData<PagingData<Data>> {
        return Pager(
            config = PagingConfig(
                pageSize = 20,
            ...
            pagingSourceFactory = {
                CryptoListPagingSource(sortText,sortDesc,cryptoText,tagText)
            }
        ).liveData
    }
}